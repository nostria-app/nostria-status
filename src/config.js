...
const config = {
  ...
  services: [
    ...
    {
      name: "Nostria API",
      url: "https://api.nostria.app/api/status/health",
      method: "GET",
      expectedStatus: 200,
    },
    {
    ...
    {
      name: "User Relay Ribo (US)",
      url: "https://ribo.us.nostria.app",
      method: "GET",
      expectedStatus: 200,
    },
    {
      name: "Media Server Mibo (US)",
      url: "https://mibo.us.nostria.app",
      method: "GET",
      expectedStatus: 200,
    },
    {
